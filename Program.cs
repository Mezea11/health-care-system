...
users.Add(new User(3, "admin2", "123", Role.Admin));
users.Add(new User(4, "admin3", "123", Role.Admin));
users.Add(new User(4, "admin4", "123", Role.Admin));
...
static void SuperAdminMenu(List<IUser> users, List<Location> locations) // creates a menu for superadmin with list of users and locations
{
    ...
    Console.WriteLine("5. Assign admins to certain regions");
